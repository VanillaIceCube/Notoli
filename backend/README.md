...
- Shared board activity creates notifications for other board members when a user is added as a collaborator, when a list is created or updated, when a note is created or updated, and when boards/lists/notes are deleted.
