...
- Shared board activity creates notifications for other board members when a user is added as a collaborator, when a list is created, when a note is created, and when a note transitions to `Complete`.
